...
public class CaptureView extends View {
    ...
    public void init(Context context) {
        ...
        frameDrawable = ContextCompat.getDrawable(context, R.mipmap.qrcode_scan_frame);
        scannerDrawable = ContextCompat.getDrawable(context, R.mipmap.qrcode_scan_scaner);
    }
