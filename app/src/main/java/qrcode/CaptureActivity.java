...
import com.example.fei.clinicalmobilenursingsystem.activity.BaseActivity;
import com.google.zxing.Result;
import com.google.zxing.ResultPoint;

import qrcode.camera.CameraManager;
import qrcode.camera.PreviewFrameShotListener;
import qrcode.camera.Size;
import qrcode.decode.DecodeListener;
import qrcode.decode.DecodeThread;
import qrcode.decode.LuminanceSource;
import qrcode.decode.PlanarYUVLuminanceSource;
import qrcode.decode.RGBLuminanceSource;
import qrcode.util.DocumentUtil;
import qrcode.view.CaptureView;

public class CaptureActivity extends BaseActivity implements SurfaceHolder.Callback, PreviewFrameShotListener, DecodeListener, OnClickListener {
	...
	public void initView() {
		...
		flashCb = (Button) findViewById(R.id.cb_capture_flash);
		flashCb.setOnClickListener(this);
